<template>
  <div class="grey lighten-4" style="font-family: Arial">
    <v-row justify="center">
      <v-col cols="auto" style="padding-bottom: 60px">
        <router-link to="/">
          <v-img
              :src="require('@/assets/img/로고.png')" width="250" class="mx-auto mb-6"/>
        </router-link>
        <v-card width="460">
            ...
            <v-form @submit.prevent="onSubmit" ref="form">
              ...
              <div class="d-flex">
                ...
                <v-btn text large outlined style="font-size: 13px"
                       class="mt-3 ml-5" color="black lighten-5"
              ...
              <v-btn type="submit" block x-large rounded
                     class="mt-6" color="grey darken-2 white--text" :disabled="(emailPass & streetPass) == false || addressDetail == ''">
                가입하기
              </v-btn>
