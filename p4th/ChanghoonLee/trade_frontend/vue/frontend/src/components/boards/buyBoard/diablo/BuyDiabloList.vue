  ...
  <v-container>
    <div>
      ...
      <table class="boards" border="1">
        ...
        <tbody>
        <tr v-if="!buyDiabloBoards || (Array.isArray(buyDiabloBoards) && buyDiabloBoards.length === 0)">
          <td colspan="4">
            현재 등록된 게시물이 없습니다!
          </td>
        </tr>
        <tr v-else v-for="buyDiabloBoard in buyDiabloBoards" :key="buyDiabloBoard.buyDiabloNo">
          <td align="center">
            {{ buyDiabloBoard.buyDiabloNo }}
          </td>
          <td align="left">
          ...
          <td align="left">
            {{ buyDiabloBoard.writer }}
          </td>
          <td align="center">
            {{ buyDiabloBoard.regDate }}
          </td>
        </tr>
        </tbody>
      </table>
