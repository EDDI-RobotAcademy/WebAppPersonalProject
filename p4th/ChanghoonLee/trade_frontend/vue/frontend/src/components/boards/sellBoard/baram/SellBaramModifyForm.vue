    ...
    <form @submit.prevent="onSubmit">
      <table class="boards">
        ...
        <tr>
          ...
          <td>
            <input type="text" :value="sellBaramBoard.writer" disabled>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
            <input type="text" :value="sellBaramBoard.regDate" disabled>
          </td>
        </tr>
        <tr>
          <th scope="row">내용</th>
...
export default {
  ...
  created () {
    this.title = this.sellBaramBoard.title
    this.writer = this.sellBaramBoard.writer
    this.content = this.sellBaramBoard.content
    this.regDate = this.sellBaramBoard.regDate
  },
  methods: {
    onSubmit () {
