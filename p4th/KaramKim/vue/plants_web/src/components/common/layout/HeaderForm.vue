<template>
  <div>
    <v-app-bar app color="white" height="150px" class="elevation-1">
      <v-spacer></v-spacer>
      <v-toolbar-title align="center">
        <router-link style="text-decoration: none;" to="/">
          <v-img
              ...
              style="float: left"
          ></v-img>
          <div class="light-green--text mt-1" style="width: 300px; height: 80px">
            <b style="font-size: 50px; font-weight: bold">PLANTS</b>
          </div>
        </router-link>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <div style="height: 120px;" v-if="!this.$store.state.checkUserInfo">
...
export default {
  ...
  methods: {
    logout() {
      ...
      this.$store.state.checkUserInfo = false
