            ...
            <v-form @submit.prevent="onSubmit" ref="form">
              ...
              <div class="d-flex">
                ...
                <v-btn text large outlined style="font-size: 13px"
                       class="mt-3 ml-5" color="amber lighten-4"
              ...
              <div class="d-flex">
                <v-text-field v-model="password" label="비밀번호" type="password"  color="amber lighten-4"
                              :rules="password_rule" :disabled="false" required/>
              </div>

              <div class="d-flex">
                <v-text-field v-model="password_confirm" label="비밀번호 확인" type="password"  color="amber lighten-4"
                              :rules="password_confirm_rule" :disabled="false" required/>
              </div>

              <div class="d-flex">
                <v-text-field v-model="city" label="도시" color="amber lighten-4"
                              :disabled="true" required/>
              </div>

              <div class="d-flex">
                <v-text-field v-model="street" label="기본 주소"  color="amber lighten-4"
                              :disabled="true" required/>
              </div>

              <div class="d-flex">
                <v-text-field v-model="addressDetail" label="상세 주소"  color="amber lighten-4"
                              :disabled="false" required/>
              </div>

              <div class="d-flex">
                <v-text-field v-model="zipcode" label="우편번호"  color="amber lighten-4"
                              :disabled="true" required/>
              ...
              <v-btn type="submit" block x-large rounded
                     class="mt-6" color="amber lighten-4" :disabled="(emailPass & streetPass) == false">
                가입하기
              </v-btn>
